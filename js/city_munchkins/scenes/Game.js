...
export class Game extends Phaser.Scene{
    ...
    preload(){
        this.load.image('tiles', '../Constellation/assets/tile_pack_munchkins.png');
        this.load.tilemapTiledJSON('karta', '../Constellation/assets/json/map.json');
        this.load.image('house_s',"../Constellation/assets/house_munchkins.png")
        this.load.image('house_u',"../Constellation/assets/house_update_munchkins.png")
    }
    create(){  
        ...
        map.objects.forEach(element => {
            element.objects.forEach(el =>{
                ...
                if(element.name == "house_obj"){
                    img.setAttribute("style",`--image:${`url("assets/house_munchkins.png")`}`)
                }else{
                    img.setAttribute("style",`--image:${`url("assets/house_update_munchkins.png")`}`)
                }
