...
<html lang="ru">
    <?php 
        session_start();
        if(!isset($_SESSION['logged_user']) || $_SESSION['logged_user'] != "winkies"){
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/winkies.css" type="text/css">
        <link rel="shortcut icon" href="img/frog_sheet_icon.png" type="image/png">
        <script src="https://cdn.jsdelivr.net/npm/phaser@3.55.2/dist/phaser.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/phaser@3.55.2/dist/phaser.min.js"></script>
        <title>Город | Мигуны</title>
    </head>
    <body>
        <div class="wrapper">
            <header>
        ...
        <script src="js/city_winkies/main.js" type="module"></script>
    </body>
</html>